  ...
  rec['{f_name}'] = rec.env['multi.approval.type'].compute_need_approval(rec)
    ...
    def create_view(self, f_name, f_name1, f_name2):
        ...
        btn_req_node = E.button(
            ...
            invisible="f_name == False or f_name == True",
        )
        ...
        div_node1 = E.div(
            ...
            {'class': "alert alert-info", 'style': 'margin-top: 5px;',
             'role': 'alert'},
            invisible = "f_name == False or f_name1 != False"
        )
        div_node2 = E.div(
            'Est documento ha sido aprobado !',
            {'class': "alert alert-info", 'style': 'margin-top: 5px;',
             'role': 'alert'},
            invisible="f_name == False or f_name1 != 'approved'"
        )
        div_node3 = E.div(
            'Este documento ha sido rechazado !',
            {'class': "alert alert-danger", 'style': 'margin-top: 5px;',
             'role': 'alert'},
            invisible="f_name == False or f_name1 != 'refused'"
        )
        div_node = E.div(
            div_node1,
            div_node2,
